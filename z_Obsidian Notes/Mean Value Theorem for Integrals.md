The [[Mean Value Theorem]] for [[Integral]]s states that if $f(x)$ is continuous on the closed interval $[a, b]$, then there exists at least one point $c$ in $[a,b]$ such that:
